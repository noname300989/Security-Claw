...
program.name("ai-offensive").description("Offensive security tool for AI/LLM systems");
...
program
  ...
  .action(async (target, options) => {
    console.log(
      `[*] Simulating prompt injection on ${target} using payload: ${options.payload || "default"}...`,
    );
